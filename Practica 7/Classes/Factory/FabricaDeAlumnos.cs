...
using Practica_7.Classes.Decorator;
using Practica_7.Classes.Proxy;
using Practica_7.Composite;
using System;
using System.Collections.Generic;
using System.Net;


namespace Practica_7.Classes.Factory
{
    public abstract class FabricaDeAlumnos
    {
        ...
        /// <summary>
        /// Crea un Alumno seleccionado DesdeArchivo.
        /// 
        /// <list type="bullet">
        /// <b>Opciones:</b>
        /// <item>
        ...
        /// El Alumno Aleatorio elegido de tipo <see cref="IAlumno"/>
        /// </returns>
        public static IAlumno CrearDesdeArchivo(int opcion)
        {
            FabricaDeAlumnos factory = null;
            switch (opcion)
            {
                case AlumnoNormal:
                    factory = new FabricaDeAlumnoNormalDesdeArchivo();
                    break;
                case AlumnoFavorito:
                    factory = new FabricaDeAlumnoFavoritoDesdeArchivo();
                    break;
                case AlumnoMuyEstudioso:
                    factory = new FabricaDeAlumnoMuyEstudiosoDesdeArchivo();
                    break;
                case AlumnoNormalProxy:
                    factory = new FabricaDeAlumnoNormalProxyDesdeArchivo();
                    break;
                case AlumnoFavoritoProxy:
                    factory = new FabricaDeAlumnoFavoritoProxyDesdeArchivo();
                    break;
                case AlumnoMuyEstudiosoProxy:
                    factory = new FabricaDeAlumnoMuyEstudiosoProxyDesdeArchivo();
                    break;
                case AlumnoCompuesto:
                    factory = new FabricaDeAlumnoCompuestoDesdeArchivo();
                    break;
            }
            return factory.CrearAlumno();
        }
    ...
    public class FabricaDeAlumnoNormalAleatorio : FabricaDeAlumnos
    {
        ...
        {
            string nombre = $"{apellidos[manejador.numeroAleatorio(36)]} {nombres[manejador.numeroAleatorio(40)]}";
    ...
    public class FabricaDeAlumnoNormalProxyAleatorio : FabricaDeAlumnos
    {
        ...
        /// </summary>
        /// <returns>
        /// Un Alumno Normal Proxy Aleatorio de tipo <see cref="IAlumno"/>
        /// </returns>
        public override IAlumno CrearAlumno()
        {
            string nombre = $"{apellidos[manejador.numeroAleatorio(36)]} {nombres[manejador.numeroAleatorio(40)]}";
    ...
    public class FabricaDeAlumnoFavoritoProxyAleatorio : FabricaDeAlumnos
    {
        ...
        /// </summary>
        /// <returns>
        /// Un Alumno Favorito Proxy Aleatorio de tipo <see cref="IAlumno"/>
        /// </returns>
        public override IAlumno CrearAlumno()
        {
            string nombre = $"{apellidos[manejador.numeroAleatorio(36)]} {nombres[manejador.numeroAleatorio(40)]}";
    ...
    {
        /// <summary>
        /// Crea un Alumno Muy Estudioso Proxy Aleatorio.
        /// </summary>
        /// <returns>
        /// Un Alumno Muy Estudioso PRoxy Aleatorio de tipo <see cref="IAlumno"/>
        /// </returns>
        public override IAlumno CrearAlumno()
        {
            string nombre = $"{apellidos[manejador.numeroAleatorio(36)]} {nombres[manejador.numeroAleatorio(40)]}";
    ...
    /***************    DESDE ARCHIVO     ********************/
    /// <summary>
    /// Fabrica concreta de Alumno Normal DesdeArchivo
    /// </summary>
    public class FabricaDeAlumnoNormalDesdeArchivo : FabricaDeAlumnos
    {
        /// <summary>
        /// Crea un Alumno Normal DesdeArchivo.
        /// </summary>
        /// <returns>
        /// Un Alumno Normal DesdeArchivo de tipo <see cref="IAlumno"/>
        /// </returns>
        public override IAlumno CrearAlumno()
        {
            ...
            Numero legajo = (Numero)(new FabricaDeNumeroLegajoDesdeArchivo().CrearComparable());
            Numero promedio = (Numero)(new FabricaDeNumeroPromedioDesdeArchivo().CrearComparable());
    ...
    /// Fabrica concreta de Alumno Favorito Aleatorio
    /// </summary>
    public class FabricaDeAlumnoFavoritoDesdeArchivo : FabricaDeAlumnos
    {
        /// <summary>
        /// Crea un Alumno Favorito DesdeArchivo.
        /// </summary>
        /// <returns>
        /// Un Alumno Favorito DesdeArchivo de tipo <see cref="IAlumno"/>
        /// </returns>
        public override IAlumno CrearAlumno()
        {
            string nombre = $"{manejador.stringDesdeArchivo(manejador.numeroAleatorio(12))} {manejador.stringDesdeArchivo(manejador.numeroAleatorio(12))}";
    ...
    /// <summary>
    /// Fabrica concreta de Alumno Muy Estudioso DesdeArchivo
    /// </summary>
    public class FabricaDeAlumnoMuyEstudiosoDesdeArchivo : FabricaDeAlumnos
    {
        /// <summary>
        /// Crea un Alumno Muy Estudioso DesdeArchivo.
        /// </summary>
        /// <returns>
        /// Un Alumno MuyEstudioso DesdeArchivo de tipo <see cref="IAlumno"/>
        /// </returns>
        public override IAlumno CrearAlumno()
        {
            string nombre = $"{manejador.stringDesdeArchivo(manejador.numeroAleatorio(12))} {manejador.stringDesdeArchivo(manejador.numeroAleatorio(12))}";
    ...
    /// <summary>
    /// Fabrica concreta de Alumno Normal Proxy DesdeArchivo
    /// </summary>
    public class FabricaDeAlumnoNormalProxyDesdeArchivo : FabricaDeAlumnos
    {
        /// <summary>
        /// Crea un Alumno Normal Proxy DesdeArchivo.
        /// </summary>
        /// <returns>
        /// Un Alumno Normal Proxy DesdeArchivo de tipo <see cref="IAlumno"/>
        /// </returns>
        public override IAlumno CrearAlumno()
        {
            string nombre = $"{manejador.stringDesdeArchivo(manejador.numeroAleatorio(12))} {manejador.stringDesdeArchivo(manejador.numeroAleatorio(12))}";
    ...
    /// <summary>
    /// Fabrica concreta de Alumno Favorito Proxy DesdeArchivo
    /// </summary>
    public class FabricaDeAlumnoFavoritoProxyDesdeArchivo : FabricaDeAlumnos
    {
        /// <summary>
        /// Crea un Alumno Favorito Proxy DesdeArchivo.
        /// </summary>
        /// <returns>
        /// Un Alumno Favorito Proxy DesdeArchivo de tipo <see cref="IAlumno"/>
        /// </returns>
        public override IAlumno CrearAlumno()
        {
            string nombre = $"{manejador.stringDesdeArchivo(manejador.numeroAleatorio(12))} {manejador.stringDesdeArchivo(manejador.numeroAleatorio(12))}";
    ...
    /// <summary>
    /// Fabrica concreta de Alumno Muy Estudioso Proxy DesdeArchivo
    /// </summary>
    public class FabricaDeAlumnoMuyEstudiosoProxyDesdeArchivo : FabricaDeAlumnos
    {
        /// <summary>
        /// Crea un Alumno Muy Estudioso Proxy DesdeArchivo.
        /// </summary>
        /// <returns>
        /// Un Alumno Muy Estudioso Proxy DesdeArchivo de tipo <see cref="IAlumno"/>
        /// </returns>
        public override IAlumno CrearAlumno()
        {
            string nombre = $"{manejador.stringDesdeArchivo(manejador.numeroAleatorio(12))} {manejador.stringDesdeArchivo(manejador.numeroAleatorio(12))}";
    ...
    /// <summary>
    /// Fabrica concreta de Alumno Compuesto Desde Archivo
    /// </summary>
    public class FabricaDeAlumnoCompuestoDesdeArchivo : FabricaDeAlumnos
    {
        /// <summary>
        /// genera un Alumno compuesto de 5 Alumnos proxy (eligiento aleatoriamente entre alumnos muy estudiosos DesdeArchivo y normales DesdeArchivo)
        /// </summary>
        /// <returns>Un Alumno Compuesto de Alumnos Normales y  Alumnos Muy Estudiosos con datos obtenidos Desde Archivo</returns>
        public override IAlumno CrearAlumno()
        {
            ...
            {
                IAlumno a;
                if (manejador.numeroAleatorio(10) > 5)
                {
                    a = FabricaDeAlumnos.CrearDesdeArchivo(4);
                }
                else
                {
                    a = FabricaDeAlumnos.CrearDesdeArchivo(6);
                }
